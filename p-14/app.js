...
function handleBgFileDeleteBtn(
	...
	return function () {
		...
		document.getElementById("bg-size").selectedIndex = 0;
		document.getElementById("bg-repeat").selectedIndex = 0;
		document.getElementById("bg-position").selectedIndex = 0;
		document.getElementById("bg-attachment").selectedIndex = 0;
	};
}
